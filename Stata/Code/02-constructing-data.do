...
*------------------------------------------------------------------------------- 
	...
	lab var		area_acre "Farm area in acres"
...
*------------------------------------------------------------------------------- 	
	...
	replace treat_cost = m_cost if mi()	
	
				//Cost in USD
	gen treat_cost_m = treat_cost * $usd
	...
	*lab var ??? 		???
	*lab var ??? 		???
	lab var treat_cost_m	"Total cost of treatment (USD)"
...
*------------------------------------------------------------------------------- 	
	...
	merge 1:1 hhid using `mem', assert(3) nogen 
 	...
 	merge m:1 vid using "${data}\Raw\treat_status.dta", assert(3) nogen 
...
*------------------------------------------------------------------------------- 	
	...
	egen n_medical = rowtotal(n_hospital n_clinic), m
